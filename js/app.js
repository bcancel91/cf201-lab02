...
var answerFourBee; // added in day 2 of this lab due to latest requirements
...
//}
answerFourBee = prompt ("Did my career take me to far away places?")
answerFourBee = answerFourBee.charAt(0).toUpperCase() + answerFourBee.slice(1)
if (answerFourBee == 'Y' || answerFourBee == 'Yes') {
  correctAnswerCount++
  console.log ('correctAnswerCount is' + correctAnswerCount + '.');
  alert('Correct!')
} else {
  alert("I did see other parts of the world, for which I am very thankful.")
}
